...
| -------------------- | -------------------- |
|                      |<!-- blog starts -->
~ [Setting up a packaging environment for Alpine Linux (introducing alpkg)](https://0xrinx.is-cool.dev/first/)<br>~ [second post in here](https://0xrinx.is-cool.dev/second/)
<!-- blog ends -->
